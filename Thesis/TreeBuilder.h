...
private:
	...
	/// <returns></returns>
	Object::GeometricObject* BuildObject(Command* command)
	{
		...
		if (command->operationType == operationType::Point) {
			...
			if (command->typeOfParameters == 1) {
				...
				Object::Point* Parent = (Object::Point*)FindObjectByName(Objects, command->CommandParameterVector->at(3));
			...
			if (command->operationType == operationType::LinearInterpolationDist) {
				Object::Point* p1 = (Object::Point*)FindObjectByName(Objects, command->CommandParameterVector->at(0));
				Object::Point* p2 = (Object::Point*)FindObjectByName(Objects, command->CommandParameterVector->at(1));
				...
				if (command->operationType == operationType::LinearInterpolationPerc) {
					...
					if (command->operationType == operationType::Intersection_Plane_Line) {
						Object::Line* l = (Object::Line*)FindObjectByName(Objects, command->CommandParameterVector->at(0));
						Object::Surface* s = (Object::Surface*)FindObjectByName(Objects, command->CommandParameterVector->at(1));
						Operations::Err err;
						...
						if (command->operationType == operationType::SurfaceCenterBoundingSquare) {
							Object::Surface *t = (Object::Surface*)FindObjectByName(Objects, command->CommandParameterVector->at(0));
							//TODO  
							...
							if (command->operationType == operationType::SurfaceCenterAverage) {
								...
								if (command->operationType == operationType::Centroid) {
									Object::Triangle *t = (Object::Triangle*)FindObjectByName(Objects, command->CommandParameterVector->at(0));
											...
											if (command->operationType == operationType::Orthocenter) {
												...
												if (command->operationType == operationType::NinePointCenter) {
													...
													if (command->operationType == operationType::ObjectCenterBoundingBox) {
														Object::Shape3D *t = (Object::Shape3D*)FindObjectByName(Objects, command->CommandParameterVector->at(0));
														//TODO
														RetObject = new Object::Point();
													}
													else
		...
		if (command->operationType == operationType::Line) {
			...
			if (command->operationType == operationType::MinLineBetweenLineAndLine) {
				Object::Line *l1 = (Object::Line*)FindObjectByName(Objects, command->CommandParameterVector->at(0));
				Object::Line *l2 = (Object::Line*)FindObjectByName(Objects, command->CommandParameterVector->at(1));
				bool errOut = false;
			...
			if (command->operationType == operationType::MinLineBetweenPointAndLine) {
				Object::Point *p = (Object::Point*)FindObjectByName(Objects, command->CommandParameterVector->at(0));
				Object::Line *l = (Object::Line*)FindObjectByName(Objects, command->CommandParameterVector->at(1));
			...
			if (command->operationType == operationType::SurfaceNormal) {
				Object::Surface *s = (Object::Surface*)FindObjectByName(Objects, command->CommandParameterVector->at(0));
				RetObject = new Object::Line(Operations::SurfaceNormal(s));
			}
		else
			if (command->operationType == operationType::LineRelocationByPoint) {
				Object::Line *l = (Object::Line*)FindObjectByName(Objects, command->CommandParameterVector->at(0));
				Object::Point *p = (Object::Point*)FindObjectByName(Objects, command->CommandParameterVector->at(1));
		...
		///Surface Commands:
			...
			if (command->operationType == operationType::RectangleFromLine) {
				...
				if (command->typeOfParameters == 1)
				{
					Object::Point surfacePoint = *(Object::Point*)FindObjectByName(Objects, command->CommandParameterVector->at(2));
				...
				{
					Object::Line *normalVector = (Object::Line*)FindObjectByName(Objects, command->CommandParameterVector->at(2));
					RetObject = Operations::AddWidthToLineVec(*l, width, *normalVector, type);
				}
			}
		else
			if (command->operationType == operationType::Circle) {
				Object::Point center = *(Object::Point*)FindObjectByName(Objects, command->CommandParameterVector->at(0));
				if (command->typeOfParameters == 1)
				{
				...
				{
					Object::Point *outlinePoint = (Object::Point*)FindObjectByName(Objects, command->CommandParameterVector->at(1));
					Object::Point *planePoint = (Object::Point*)FindObjectByName(Objects, command->CommandParameterVector->at(2));
			...
			if (command->operationType == operationType::Triangle) {
				if (command->typeOfParameters == 1)
				{
					Object::Point *p1 = (Object::Point*)FindObjectByName(Objects, command->CommandParameterVector->at(0));
					Object::Point *p2 = (Object::Point*)FindObjectByName(Objects, command->CommandParameterVector->at(1));
					Object::Point *p3 = (Object::Point*)FindObjectByName(Objects, command->CommandParameterVector->at(2));
			...
			if (command->operationType == operationType::Rectangle) {
				...
				Object::Line *normal = (Object::Line*)FindObjectByName(Objects, command->CommandParameterVector->at(4));
			...
			if (command->operationType == operationType::Polygon) {
				...
				{
					pointsVector.push_back(*(Object::Point*)FindObjectByName(Objects, command->CommandParameterVector->at(i)));
				}
